      ...
      sounds: [
        {
          ...
          path: 'https://raw.githubusercontent.com/RossMcMillan92/djent/master/src/assets/audio/mastered/hihat-open.wav',
          category: 'Hihat',
          midi: {
            pitch: [
              'A#2'
        ...
        },
        {
          ...
          path: 'https://raw.githubusercontent.com/RossMcMillan92/djent/master/src/assets/audio/mastered/hihat-closed.wav',
          category: 'Hihat',
          midi: {
            pitch: [
              'A#2'
...
describe('Presets', () => {
    describe('createPresetFactory', () => {
        it('doesn\'t add unnecessary props', () => {
            ...
            expect(result).toEqual(presetOutput)
        })
